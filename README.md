...
[hermes-agent](https://github.com/NousResearch/hermes-agent) — **28 chapters**
...
| 8 | Deep dive — model/credentials/routing & runtime resilience | 27–28 |
...
的**图解、双语**学习指南，共 **28 章**，讲清楚*每个部件在设计时想达成什么*、
