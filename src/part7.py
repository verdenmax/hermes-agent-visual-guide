...
<svg viewBox="0 0 680 300" role="img" aria-label="HARDLINE 与 DANGEROUS 两类危险命令按不可逆程度分级">
  ...
  <text x="502" y="60" text-anchor="middle" font-size="12.5" font-weight="700" fill="var(--panel)">DANGEROUS · 47 条 · 黄线</text>
...
<div class="fig-cap"><b>HARDLINE vs DANGEROUS 分级</b>：危险命令按<b>不可逆程度</b>分两级。<b>HARDLINE</b>（删根 / 格式化 / 写裸盘 / fork 炸弹）一旦执行就<b>不可逆</b>、几乎无正当理由，故焊成红线——连 <span class="mono">/yolo</span> 都拦、零容忍；<b>DANGEROUS</b>（其余 47 条）危险但在受控场景可能正当，留了 <span class="mono">/yolo</span> 一次放行的口子，智能审批也只能<b>放宽</b>、无权松动红线。可逆的给方便，不可逆的零容忍。</div>
</div>
...
<svg viewBox="0 0 680 300" role="img" aria-label="HARDLINE versus DANGEROUS: two tiers of dangerous commands graded by irreversibility">
  ...
  <rect x="352" y="38" width="300" height="200" rx="10" fill="var(--amber-soft)" stroke="var(--amber)"/>
  <rect x="352" y="38" width="300" height="34" rx="10" fill="var(--amber)"/>
  <text x="502" y="60" text-anchor="middle" font-size="12.5" font-weight="700" fill="var(--panel)">DANGEROUS · 47 · yellow lines</text>
  <g font-size="11.5" fill="var(--ink)">
