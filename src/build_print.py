...
TITLE = {"zh": "Hermes Agent 设计图解 · 打印版", "en": "Hermes Agent Design Guide · Print Edition"}
INTRO = {
    "zh": "全 25 章 · 逐章分页。用浏览器 Ctrl/Cmd+P 即可导出 PDF。",
    "en": "All 25 chapters - one page each. Use Ctrl/Cmd+P in a browser to export a PDF.",
}
