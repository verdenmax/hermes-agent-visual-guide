...
<div class="fig-cap"><b>The seven LLM constraints A–G at a glance</b>: <b>A·lost-in-the-middle / B·statelessness / E·brittle structured output</b> already bite on a <b>single call</b>; <b>C·hallucination / D·instructions=data / F·error accumulation / G·ops</b> only surface once you string the model into an <b>autonomous agent</b>. This chapter focuses on B·statelessness — the other six unfold in ch.2–3, and the full A–G is the “why” behind every later chapter's infrastructure.</div>
</div>
